...
# Modelos para guardar las habitaciones en la abse de datos
class Habitacion(models.Model):
    ...
    hotel = models.ForeignKey(
        User, on_delete=models.CASCADE, limit_choices_to={"rol": "hotel"}
    )
...
# Modelo para guardar las reservas en la base de datos
class Reserva(models.Model):
    ...
    correo = models.EmailField(
        max_length=254, null=False, default="hotelera.com@gmail.com"
    )
...
# Modelo para guardar la asociacion de una reserva con una habitacion
...
class ComprobantePago(models.Model):
    reserva = models.ForeignKey(
        Reserva, on_delete=models.CASCADE, related_name="comprobantes"
    )
...
# Modelo para guardar el reporte contable
